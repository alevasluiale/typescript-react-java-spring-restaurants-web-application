...
const Restaurants: React.FC<{
  restaurants?: [Restaurant]
   ...
   modifyRestaurant: (restaurant:Restaurant) => void
   addRestaurant: (restaurant:Restaurant) => void
  }> = ({restaurants,deleteRestaurant,modifyRestaurant,addRestaurant}) => {
  ...
  return (
    <div className={classes.root}>
      <Formik 
        ...
        onSubmit={(values)=> addRestaurant(values)}
      >
        { props => (
      ...
      >
        <Formik 
          ...
          onSubmit={(values)=> modifyRestaurant(values)}
        >
          { props => (
